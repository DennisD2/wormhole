...
public class LoadDataTest {
	...
	public void testLoadImages() {
		loadImages("/home/dennis/tek1241-tpg-test-glitches_6mhz_50ns.tek");
	}
	...
	public void loadImages(String file) {
		...
		tek.getTekRaw().printRawTpgPat();
		tek.getTekRaw().printRawOpLevel();
		tek.getTekRaw().printRawTb1Clock();
		tek.getTekRaw().printRawPolarity();
	}
